...
def run_intensive_tests():
    ...
    from maintenance_management.maintenance_management.api import whatsapp_webhook_receiver
    ...
    from maintenance_management.maintenance_management.api import optimize_technician_routes
    ...
    from maintenance_management.maintenance_management.api import run_predictive_maintenance_analysis
    pred_res = run_predictive_maintenance_analysis()
    print(f"✓ Predictive Maintenance analysis result: {pred_res}")
    
    # 6. Test QR Asset Code
    from maintenance_management.maintenance_management.api import scan_asset_qr_code
    qr_res = scan_asset_qr_code("EQ-HVAC-101")
    print(f"✓ QR Asset Scan result: {qr_res}")
    
    # 7. Test Regional P&L Summary
    from maintenance_management.maintenance_management.api import get_regional_profit_loss_summary
